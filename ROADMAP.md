...
**Agent onboarding**: The agent receives the AST schema (TypeScript interfaces) and 41 example programs as part of its system prompt or MCP resource. No documentation needed — the schema *is* the spec.
...
edict.examples()        → 41 example programs as AST JSON (with schema snippet)
